...
class PoemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poem" do
    assert_difference('Poem.count') do
      post poems_url, params: { poem: { body: @poem.body, image_url: @poem.image_url, shared: @poem.shared, title: @poem.title, user_id: @poem.user_id } }
    end
  ...
  test "should update poem" do
    patch poem_url(@poem), params: { poem: { body: @poem.body, image_url: @poem.image_url, shared: @poem.shared, title: @poem.title, user_id: @poem.user_id } }
